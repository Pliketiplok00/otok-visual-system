  ...
  return <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 bg-vis-blue text-background flex flex-col items-center justify-center px-6 py-12 relative">
        ...
        <div className="relative z-10 mb-8">
          <div className="w-36 h-36 bg-vis-yellow border-[4px] border-foreground flex items-center justify-center" style={{
      ...
      <div className="bg-background px-6 py-8 border-t-[4px] border-foreground">
        ...
        <div className="space-y-4">
          <button onClick={() => navigate('/login')} className="w-full border-[3px] border-foreground bg-vis-yellow px-6 py-4 font-bold uppercase tracking-wide flex items-center justify-center gap-3 hover:translate-x-[2px] hover:translate-y-[2px] transition-transform" style={{
          ...
          <button onClick={() => navigate('/login')} className="w-full border-[3px] border-foreground bg-vis-cyan px-6 py-4 font-bold uppercase tracking-wide flex items-center justify-center gap-3 hover:translate-x-[2px] hover:translate-y-[2px] transition-transform" style={{
